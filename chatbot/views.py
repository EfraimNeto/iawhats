...
# Configura a chave de API para o modelo de linguagem
...
def chatbot(request):
    ...
    if request.method == 'POST':
        ...
        # Cria uma nova entrada de chat com mensagem, resposta e horário de criação
        ...
        return JsonResponse({
            'message': message,
            'response': response,
            'created_at': chat.created_at.isoformat()  # Envia data completa no formato ISO
        })
